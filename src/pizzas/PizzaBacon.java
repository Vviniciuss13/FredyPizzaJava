...
public class PizzaBacon implements Pizza {
	...
	public PizzaBacon(String nome, double preco, int tempo) {
		this.nome = nome;
		this.preco = preco;
		this.tempo = tempo;
	}
	...
	// Faz a pizza
	public void doPizza() {
		System.out.printf("Fazendo Pizza de Bacon, irá demorar %d minutos \n", this.tempo);
	}
	...
	public void attach(Cliente observer) {
		...
		System.out.println("Pizza de Bacon adicionada aos favoritos do " + observer.name);
	}
	...
	public void detach(Cliente observer) {
		...
		System.out.println("Pizza de Bacon removida dos favoritos do " + observer.name);
	}
				

	// Notifica todos os clientes na pizza favorita
	public void notificar() {
		System.out.println("Notificando os Cliente da Pizza de Bacon");
	...
	public void pizzaDesconto(double desconto) {
		...
		System.out.println("Preço da Pizza de Bacon atualizado...");
		System.out.println();
		this.notificar();
