...
public class PizzaCostela implements Pizza {
	...
	public PizzaCostela(String nome, double preco, int tempo) {
		this.nome = nome;
		this.preco = preco;
		this.tempo = tempo;
	}
	...
	// Faz a pizza
	public void doPizza() {
		System.out.printf("Fazendo Pizza de Costela, irá demorar %d minutos \n", this.tempo);
	}
	...
	// Atribui um cliente na pizza favorita
		...
		public void attach(Cliente observer) {
			...
			System.out.println("Pizza de Costela adicionada aos favoritos do " + observer.name);
		}
		...
		public void detach(Cliente observer) {
			...
			System.out.println("Pizza de Costela removida dos favoritos do " + observer.name);
		}
			

		// Notifica todos os clientes na pizza favorita
		public void notificar() {
			System.out.println("Notificando os Cliente da Pizza de Costela");
	...
	public void pizzaDesconto(double desconto) {
		...
		System.out.println("Preço da Costela atualizado...");
		System.out.println();
		this.notificar();
