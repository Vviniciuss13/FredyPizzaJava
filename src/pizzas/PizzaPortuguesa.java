...
public class PizzaPortuguesa implements Pizza {
	...
	public PizzaPortuguesa(String nome, double preco, int tempo) {
		this.nome = nome;
		this.preco = preco;
		this.tempo = tempo;
	}
	...
	// Faz a pizza
	public void doPizza() {
		System.out.printf("Fazendo Pizza de Portuguesa, irá demorar %d minutos \n", this.tempo);
	}
	...
	public void attach(Cliente observer) {
		...
		System.out.println("Pizza Portuguesa adicionada aos favoritos do " + observer.name);
	...
	public void detach(Cliente observer) {
		...
		System.out.println("Pizza Portuguesa removida dos favoritos do " + observer.name);
	}
	

	// Notifica todos os clientes na pizza favorita
	public void notificar() {
		System.out.println("Notificando os Cliente da Pizza Portuguesa");
	...
	public void pizzaDesconto(double desconto) {
		...
		System.out.println("Preço da Portuguesa atualizado...");
		System.out.println();
		this.notificar();
